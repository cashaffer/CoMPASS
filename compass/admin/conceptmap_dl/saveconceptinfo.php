...
//	header("location:/compass/error_code.php?code=001"); 
	...
	if(!$priority->checkPage(8))
		...
		$id = $_REQUEST['id'];
		$sql = $sql. " where idconcept=".$id." and idunit=0 and idtopic=0 and idexample=0";
		$query = $db->query($sql);
?>
<html>
<head>
...
<table width=528 cellspacing=1 cellpadding=4 border=0 align=center class=bgcolor5>
	...
	<td colspan=2 height=150 align=center class=bgcolor1> <p> 
        <?= "Concept ".$_REQUEST['cname']." info is updated successfully!<br> Click <a href='conceptlist.php'>here</a> to continue"?>
        <br>
      </p>
	</td>
	</tr>
