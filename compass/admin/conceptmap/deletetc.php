...
//	header("location:/compass/error_code.php?code=001"); 
	...
	if(!$priority->checkPage(8))
		...
		$cid = $_REQUEST['cid'];
		$tid = $_REQUEST['tid'];
		$sql = "delete from CONCEPTINTOPIC where idtopic=".$tid." and idconcept=".$cid;
		$query = $db->query($sql);
?>
<html>
<head>
...
<table width=528 cellspacing=1 cellpadding=4 border=0 align=center class=bgcolor5>
	...
	<td colspan=2 height=150 align=center class=bgcolor1> <p> 
        <?= "Topic_Concept info is deleted successfully!<br> Click <a href='tclist.php'>here</a> to continue"?>
        <br>
      </p>
	</td>
	</tr>
