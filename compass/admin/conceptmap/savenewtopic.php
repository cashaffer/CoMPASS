...
<table width=528 cellspacing=1 cellpadding=4 border=0 align=center class=bgcolor5>
	...
	<td colspan=2 height=150 align=center class=bgcolor1> <p>
        <?= "Topic ".$name." is added successfully!<br> Click <a href='topiclist.php'>here</a> to continue"?>
        <br>
      </p>
	</td>
	</tr>
	<tr>
	<td align=center colspan=2 class=bgcolor3><input name="Submit" type="button" onClick="MM_goToURL('self','addtopic.php');return document.MM_returnValue" value="Continue to add topic"> 
    </td>
	</tr>
</table>
