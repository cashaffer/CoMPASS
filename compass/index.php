...
if ($env=getenv('PHP_PEAR_INSTALL_DIR')) {
    ...
    putenv('PHP_PEAR_INSTALL_DIR=C:\xampp\php\pear');
}

if ($env=getenv('PHP_PEAR_BIN_DIR')) {
    define("PHP_PEAR_BIN_DIR",$env);
} else {
    putenv('PHP_PEAR_BIN_DIR=C:\xampp\php');
}
if ($env=getenv('PHP_PEAR_PHP_BIN')) {
    define("PHP_PEAR_PHP_BIN",$env);
} else {
    putenv('PHP_PEAR_PHP_BIN=C:\xampp\php\php.exe');
}
...
require_once('C:\xampp\php\pear\PEAR\Frontend\CLI.php');
?>
