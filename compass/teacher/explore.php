...
<center>
  <table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
    <tr>
<td colspan="3">
        <IFRAME id="nav" name="nav" onload="javascript:{dyniframesizeHeight('nav');dyniframesizeWidth('nav');}" src="<?=$sub1?>" hspace="0" vspace="0" marginwidth=0 marginheight=0 frameborder=0 width=100% height=100% scrolling=no></IFRAME>	
</td>
</tr>
<tr>
      <td width="450" height="100%" valign="top"> 
        <applet code="com.compass.conceptmap.CompassApplet.class"
			...
			<param name="urlPrefix" value="http://<?=$_SERVER['SERVER_NAME']?>/compass/teacher/"/>
