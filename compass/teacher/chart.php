...
include "db_mysql_mt.inc"; 
 $idexploration=$_GET['idexploration'];
...
/* Build the query that will returns the data to graph */
$Requete8 = "SELECT loginname, idstudent, leader FROM exploration, user WHERE exploration.idstudent = user.iduser AND idexploration = " . $idexploration ;
$Result8  = mysql_query($Requete8,$db);
$row8 = mysql_fetch_array($Result8);
$leader = $row8["leader"];
$group = $row8["loginname"];
...
if ($leader != "")
	$myPicture->drawText(350,25,"CoMPASS Navigation - Group ".$group." (leader: " .$leader.")" ,$TextSettings);
else
	$myPicture->drawText(350,25,"CoMPASS Navigation - Group ".$group,$TextSettings);
